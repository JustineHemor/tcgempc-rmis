...
$sql = "SELECT *, tbl_members_info.member_id, tbl_members_info.lastname, tbl_members_info.firstname, tbl_loan_type.loan_type, tbl_comaker.member_id as comaker_member_id
            FROM `tbl_loan_list`
...
<div class="content-wrapper">
    ...
    <div class="page-content fade-in-up">
        <div class="ibox">
            <div class="ibox-head">
                <div class="ibox-title">Loan Information</div>
            ...
            <div class="ibox-body">
                <div class="container">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-auto">
                            <?php
                            if ($loanlistRow['comaker_confirmation'] == 'pending' || $loanlistRow['comaker_confirmation'] == 'rejected') {
                            ?>
                                <button class="btn btn-info" data-toggle="modal" data-target="#modalChangeComaker<?php echo $loan_id ?>">Change Comaker</button>
                            <?php
                            }
                            ?>
                            <?php
                            if ($loanlistRow['status'] == 'for approval') {
                            ?>
                                <button class="btn btn-secondary" data-toggle="modal" data-target="#modalCancelLoan<?php echo $loan_id ?>">
                                    <?php
                                    if ($loanlistRow['renewed'] != '') {
                                        echo 'Cancel Loan Renew';
                                    } else {
                                        echo 'Cancel Loan Request';
                                    }
                                    ?>
                                </button>
                            <?php
