        ...
        <div class="row">
            <div class="col-md-12">
                <div class="ibox">
                    ...
                    <div class="ibox-body">
                        <form method="POST" action="functions/insert.php?action=insert_member">
                            <div class="row">
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">APPLICATION FOR MEMBERSHIP</h5>
                                        ...
                                        <div class="modal-body">
                                            <div class="form-group">
                                                <label for="">Pay the minimum of shares upon filing of this application and the balance to be paid upon call. (minimum of 5 shares with par value at Php100.00 per share)</label>
                                                <input type="number" name="remittance" id="remittance" class="form-control" autocomplete="off" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="">Monthly Share for 5 years.</label>
                                                <input type="number" name="monthly_share" id="monthly_share" class="form-control" autocomplete="off" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="">Share Capital</label>
                                                <input readonly type="number" name="share_capital" id="share_capital" class="form-control" autocomplete="off" required>
                                            </div>
                                        </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#monthly_share').on('input', function() {

            let total_share = $('#monthly_share').val() * 60;

            $('#share_capital').val(total_share);
        });
