            ...
            <div class="col-md-12">
                <div class="ibox">
                    <div class="ibox-head" style="overflow-x: hidden;">
                        <div class="ibox-title">Loan Request Form</div>
                        <div class="ibox-tools">
                            <button class="btn btn-primary" id="renew_loan">Renew Loan</button>
                        </div>
                    </div>
                    <div class="ibox-body">
                        <form method="POST" action="functions/insert.php?action=request_loan">
                            <?php
                            ...
                            ?>
                            <div class="row">
                                <input hidden type="text" id="date_today" name="date_today" value="<?php echo date('Y-m-d') ?>">
                                <input hidden type="text" id="membership_date" name="membership_date" value="<?php echo $row['membership_date'] ?>">
                                <input name="member_id" id="member_id" required class="form-control" type="hidden" value="<?php echo $member_id; ?>">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#renew_loan').click(function () {
            window.location="loan_renew.php";
        });
